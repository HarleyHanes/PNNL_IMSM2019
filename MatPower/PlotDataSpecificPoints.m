...
% 300 case
% cf=4565;  % # of total files in the failure folder
% cs=5000; % # of total files in the success folder
...
legend({'fail values','suc values'},'Location','northwest','FontSize',14)
...
% title('Failures p and q max and min values','FontSize',22);
...
% plot(X,qminS,'g');
% legend('Suc p','Suc q');
% title('Successes p and q max and min values','FontSize',22);
% xlabel=('Bus Number','FontSize',16);
% ylabel=('Value','FontSize',16);
...
title('Failure p and q max and mins','FontSize',22);
xlabel('Bus Number','FontSize',16);
ylabel('value','FontSize',16);
...
title('Success p and q max and mins','FontSize',22);
xlabel('Bus Number','FontSize',16);
ylabel('value','FontSize',16);
